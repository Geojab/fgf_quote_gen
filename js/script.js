...
function renderWeddingDetails() {
    ...
    document.getElementById('wedding-brief').value = state.weddingDetails.weddingBrief || '';
}
...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('./assets/black-mango-regular.ttf') format('truetype');
            font-weight: normal;
            font-style: normal;
            font-display: swap;
        }
    ...
    <div class="quote-template">
        <div class="quote-header">
            ...
            <div class="quote-header-right">
                <img src="./assets/logo.svg" alt="Field Good Flowers" class="quote-logo">
            </div>
        </div>
